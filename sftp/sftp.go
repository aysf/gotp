...
// NewClient initialises SSH and SFTP clients and returns Client type to use
...
// Upload write local / source file data streams to remote destination file.
...
// info gets the detail of a file. If the file was not found, an error is returned
